...
public class JobRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.job_register);
        ...
        DateGet_Job.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(JobRegister.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        job_But_Save.setOnClickListener(new View.OnClickListener() {  // ปุ่ม บันทึก job_But_Save
            ...
            public void onClick(View view) {
                ...
                if (name_job.equals("") ||              //ชื่องาน
                    ...
                    Toast.makeText(JobRegister.this, getResources().getString(R.string.haveSpace), Toast.LENGTH_SHORT).show();
                } else {
                    MyJob myJob = new MyJob(JobRegister.this);
