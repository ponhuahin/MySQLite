...
/**
 * Created by User-Gamer on 2/10/2017.
 */
public class A1ListView extends BaseAdapter {

    private static Activity activity;
    private static LayoutInflater inflater;
    ArrayList<TodoList> myTodoList;

    public A1ListView(Activity activity,ArrayList<TodoList> mtTodoList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = convertView;
        v = inflater.inflate(R.layout.a1_list_view,null);
        ...
        textView2.setText(todoList1.getPassword_admin());
