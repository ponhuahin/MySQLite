...
//        final ImageView imageView = (ImageView) findViewById(R.id.Image_Emp);             //รูป               14
        ...
        final EditText A1 = (EditText) findViewById(R.id.Position_Emp_edit);        //ตำแหน่ง           15
        final EditText A2 = (EditText) findViewById(R.id.Salary_Emp_edit);          //เงินเดือน           12
//        final EditText ID_Emp = (EditText) findViewById(R.id.ID_Emp_edit);        //รหัสบัตรประชาชน     1
        final EditText A3 = (EditText) findViewById(R.id.Name_Emp_edit);            //ชื่อ               2
        final EditText A4 = (EditText) findViewById(R.id.Nickname_Emp_edit);        //ชื่อเล่น             7
        final EditText A5 = (EditText) findViewById(R.id.DateBirth_Emp_edit);       //วัน เดือน ปี เกิด      5
        final EditText A6 = (EditText) findViewById(R.id.Age_Emp_edit);             //อายุ               4
        final EditText A7 = (EditText) findViewById(R.id.Address_Emp_edit);         //ที่อยู่               6
        final EditText A8 = (EditText) findViewById(R.id.Tel_Emp_edit);             //เบอร์โทร            8
        ...
        A1.setText(editTodoList.getPosition_Emp());
        A2.setText(editTodoList.getSalary_Emp());
//        ID_Emp.setText(editTodoList.getID_Emp());
        A3.setText(editTodoList.getName_Emp());
        A4.setText(editTodoList.getNickname_Emp());
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                eTodoList.setPosition_Emp(String.valueOf(A1.getText()));            // แล้วเอา setTodoText ที่ได้มาจาก editText น่าออกแบบ
                eTodoList.setSalary_Emp(String.valueOf(A2.getText()));
                eTodoList.setName_Emp(String.valueOf(A3.getText()));
                eTodoList.setNickname_Emp(String.valueOf(A4.getText()));
